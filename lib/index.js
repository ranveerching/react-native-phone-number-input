...
export default class PhoneInput extends PureComponent {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (nextProps.disabled !== prevState.disabled) {
      if (
        ...
        return {
          ...
          countryCode: nextProps.defaultCode,
          code: nextProps.code,
        };
      }
      return {
    ...
    if (
      nextProps.defaultCode !== prevState.countryCode ||
      ...
      <CountryModalProvider>
        ...
        >
          ...
          >
            ...
            {showCross ? (
              <TouchableOpacity
                style={closeCrossContainerStyle}
                onPress={clear}
              >
                <CloseCross
                  width={closeCrossStyle.width}
                  height={closeCrossStyle.height}
                />
              </TouchableOpacity>
            ) : null}
          </View>
