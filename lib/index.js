  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (nextProps.disabled !== prevState.disabled) {
      if ( (nextProps.value || nextProps.value === "") && nextProps.value !== prevState.number) {
        return ({ disabled: nextProps.disabled, number: nextProps.value, countryCode: nextProps.defaultCode , code: nextProps.code });
      }
      return ({ disabled: nextProps.disabled, countryCode: nextProps.defaultCode , code: nextProps.code });
    }
    if(nextProps.defaultCode !== prevState.countryCode || nextProps.code !== prevState.code){
      return ({countryCode: nextProps.defaultCode , code: nextProps.code })
    }
    return null;
  };
      ...
      <CountryModalProvider>
        ...
        >
          ...
          >
            ...
            {
              showCross ? (
                <TouchableOpacity style={closeCrossContainerStyle} onPress={clear}>
                  <CloseCross width={closeCrossStyle.width} height={closeCrossStyle.height} />
                </TouchableOpacity>
              ) :
              null
            }
